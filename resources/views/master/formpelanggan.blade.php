        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <form method="post" action="<?=URL::to('simpanpelanggan') ?>">
                <input type="hidden" name="_token" value="{!! csrf_token() !!}"> <!-- agar nanti tidak mudah disusupi hacker saat input form-->
                
                <div class="form-group">
                  <label>Kode Pelanggan:</label>
                  <input type="text" name="kode" class="form-control" id="exampleInputEmail1" placeholder="Kode Pelanggan" class="form-control" required data-validation-required-message="Please enter your Code.">
                </div>
                <div class="form-group">
                  <label>Nama Pelanggan:</label>
                  <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Nama Pelanggan" class="form-control" required data-validation-required-message="Please enter your name.">
                </div>
                <div class="form-group">
                  <label>Alamat Pelanggan:</label>
                  <input type="text" name="alamat" class="form-control" id="exampleInputEmail1" placeholder="Alamat Pelanggan" class="form-control" required data-validation-required-message="Please enter your name.">
                </div>
                <div class="form-group">
                  <label>No. Telp :</label>
